...
export default function PortfolioView() {
  ...
  useEffect(() => {
    ...
    dragInstance.current = Draggable.create(canvasRef.current, {
      ...
      onPress: function () {
        // Disable drag if any project is focused
  ...
  // Update draggable state when focus changes
  ...
  useEffect(() => {
    if (dragInstance.current) {
      if (focusedProjectId) {
        ...
        // Change cursor to indicate drag is disabled
  ...
  const handleProjectSelect = (project: Project) => {
    if (focusedProjectId === project.id) {
      ...
      navigateToPosition(projectCenterX, projectCenterY);
    }
  };
          ...
          {portfolioProjects.map(
            (
              ...
              <ProjectCanvasCard
                ...
                isImageZoomed={isImageZoomed && focusedProjectId === project.id}
                index={index}
              />
            )
          )}
