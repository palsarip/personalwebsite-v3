        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <Link
              href="/"
              id="header-logo"
              className="text-xl font-serif text-slate-800 px-4 py-2 bg-white/30 backdrop-blur-lg border border-white/40 shadow-inner rounded-xl transition-colors hover:bg-white/40"
            >
              Naufal Syarif
            </Link>
          </div>
